  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <p
          className={`mt-3 text-xs ${darkMode ? "text-gray-500" : "text-gray-400"}`}
        >
          File uploads are supported by AI — please check that the correct tags
          are applied after upload.
        </p>
      </div>
