...
ALL_PERMISSIONS = [
    ...
    Permissions.DOCUMENT_PROJECT_MOVE,
    ...
    Permissions.DOCUMENT_VERSION_STAMP_ACCESS,
    Permissions.DOCUMENT_VERSION_STAMP_LABEL_CREATE,
    Permissions.DOCUMENT_VERSION_TEXT_BOX_ACCESS,
